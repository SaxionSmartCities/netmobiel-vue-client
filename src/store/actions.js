...
export default {
  ...
  fetchGeocoderSuggestions: (context, place) => {
    ...
    const GEOCODER_BASE_URL = `http://autocomplete.geocoder.api.here.com/6.2/suggest.json?app_id=${HERE_APP_ID}&app_code=${HERE_APP_CODE}&query=${place}&beginHighlight=<b>&endHighlight=</b>`
